...
public class ActivityLogService {
    ...
    public List<Map<String, Object>> getActivityLogsByUserId(Long userId) {
        String sql = "SELECT a.title AS articleTitle, c.title AS cafeTitle, a.view, a.content, a.id AS articleId, c.id AS cafeId, COUNT(av.article_id) AS voter, COUNT(co.article_id) AS comment " +
                "FROM article a " +
                ...
                "WHERE u.id = ? " +
                "GROUP BY a.title, c.title, a.view, a.content, a.id, c.id " +
